...
All the environments are registered in the `samlle_dog` extension. They start
...
import samlle_dog.tasks  # noqa: F401


def main():
    """Print all environments registered in `samlle_dog` extension."""
