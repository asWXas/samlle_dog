...
from samlle_dog.tasks.manager_based.go1.velocity_env_cfg import LocomotionVelocityRoughEnvCfg
...
class UnitreeGo1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        self.events.add_base_mass.params["mass_distribution_params"] = (11.0, 17.0)
